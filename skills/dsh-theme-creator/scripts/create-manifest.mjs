...
if (
  ...
  CERTIFIED_RUNTIME?.authoringEnabled !== false ||
...
if (
  ...
  RUNTIME_BASELINE.capabilities?.authoringEnabled !== false ||
  RUNTIME_BASELINE.itemAuthority !== 'not-granted'
) {
  throw new Error('certified runtime baseline attempts to enable authoring');
}
