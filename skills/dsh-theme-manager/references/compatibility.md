...
The local hosted authority lives in [`scripts/hosted-artifact-authority.mjs`](../scripts/hosted-artifact-authority.mjs). `CURRENT_INSTALLABLE_HOSTED_ARTIFACTS` is generated from rebuilt `public/theme-packages/index.json` SHA-256 `f706364d3f44fb0667147155c8400fe456da482fb908625e4d4c2c301022bbe6` and binds 32 exact package-version-complete-digest tuples. The declared-order JSON entry array hashes to `e3ed309a499b162041bff48e89f522b04866f612c504614fe80f5f56f2226e5c`:
