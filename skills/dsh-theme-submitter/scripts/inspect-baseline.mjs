...
if (
  ...
  (lane.status !== 'baseline-certified' ||
    ...
    evidence.capabilities?.submissionEnabled !== false ||
    evidence.itemAuthority !== 'not-granted')
) {
  fail('certified runtime baseline is malformed or enables submission');
}
process.stdout.write(`${JSON.stringify({
  ...
  submissionEnabled: lane.submissionEnabled,
  dshVersion,
